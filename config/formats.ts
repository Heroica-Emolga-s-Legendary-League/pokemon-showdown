...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	},
	{
		...
		mod: 'gen8bdsp',
		searchShow: false,
		ruleset: ['Standard Draft', 'Dynamax Clause', '+Nonexistent', '-CAP'],
	},
	{
		...
		searchShow: false,
		teraPreviewDefault: true,
		ruleset: ['Standard Draft', '+Unobtainable', '+Nonexistent', '-CAP', 'Min Source Gen = 1'],
	},
	{
	...
	},
	{
		...
		mod: 'mixandmega',
		ruleset: ['Standard OMs', 'Evasion Items Clause', 'Evasion Abilities Clause', 'Sleep Moves Clause', 'Terastal Clause', '+Unobtainable', '+Past', 'Min Source Gen = 1', '+LGPE'],
		onValidateTeam(team) {
