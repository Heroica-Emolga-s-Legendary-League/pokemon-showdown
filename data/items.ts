export const Items: import('../sim/dex-items').ItemDataTable = {
	...
	"floettiteza": {
		...
		itemUser: ["FloetteZAZA"],
		megaEvolves: "FloetteZAZA",
		num: -1008,
		isNonstandard: "Past",
		gen: 9,
		onTakeItem: (item, source) => {
...
//a
	...
	eviolite: {
		...
		onModifyDef(def, pokemon) {
			const includedSpecies = ['lanturn', 'druddigon', 'lumineon', 'wobbuffet', 'bronzong', 'heracross', 'sableye', 'kecleon', 'chatot', 'mothim', 'spiritomb', 'rampardos', 'pinsir', 'bouffalant', 'grumpig', 'alomomola', 'sigilyph', 'golisopod', 'tentacruel', 'golurk'];
