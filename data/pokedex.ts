export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	sailomola: {
		...
		name: "Sailomola",
		types: ["Water", "Fairy"],
		baseStats: { hp: 125, atk: 65, def: 70, spa: 105, spd: 45, spe: 135 },
	...
	nimbuseon: {
		...
		types: ["Flying"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 60, atk: 110, def: 65, spa: 65, spd: 95, spe: 130 },
	...
	gloomzornean: {
		...
		weightkg: 8.6,
		color: "Blue",
		prevo: "Oddish Zornean",
		evoLevel: 21,
		evos: ["Vileshroud", "Bellossom Zornean"],
		eggGroups: ["Grass"],
	},
	vileshroud: {
		num: -1692,
		...
		abilities: { 0: "Falling Flowers", H: "Cursed Body" },
		heightm: 1.2,
		weightkg: 18.6,
		color: "Red",
		prevo: "Gloom Zornean",
	...
	drowzeezornean: {
		num: -1697,
		name: "Drowzee Zornean",
		types: ["Dark"],
		baseStats: { hp: 60, atk: 48, def: 90, spa: 43, spd: 45, spe: 42 },
		abilities: { 0: "Unnerve", 1: "Forewarn", H: "Inner Focus" },
		heightm: 1,
		weightkg: 32.4,
		color: "Yellow",
		evos: ["Hypno Zornean"],
	...
	hypnozornean: {
		...
		name: "Hypno Zornean",
		types: ["Dark", "Fighting"],
		baseStats: { hp: 85, atk: 73, def: 115, spa: 73, spd: 70, spe: 67 },
		abilities: { 0: "Anger Point", 1: "Forewarn", H: "Inner Focus" },
		heightm: 1.6,
		weightkg: 75.6,
		color: "Yellow",
		prevo: "Drowzee Zornean",
		evos: ["Magnypno"],
		nfe: true,
		evoLevel: 26,
		eggGroups: ["Human-Like"],
	...
	duskullzornean: {
		...
		weightkg: 15,
		color: "Black",
		evos: ["Dusclops Zornean"],
		eggGroups: ["Amorphous"],
	},
	dusclopszornean: {
		num: -1700,
		name: "Dusclops Zornean",
		types: ["Fire", "Ghost"],
	...
	festivepass: {
		...
		abilities: { 0: "Sturdy", 1: "Vital Spirit", H: "Sand Force" },
		heightm: 1.4,
		weightkg: 160,
		color: "Gray",
		prevo: "Nosepass",
	...
	girafarigzornean: {
		num: -1703,
		name: "Girafarig Zornean",
		types: ["Ground", "Fairy"],
		baseStats: { hp: 80, atk: 65, def: 90, spa: 65, spd: 90, spe: 65 },
		abilities: { 0: "Lightning Rod", 1: "Early Bird", H: "Volt Absorb" },
		heightm: 1.5,
		weightkg: 41.5,
		color: "Yellow",
		nfe: true,
	...
	rigafagir: {
		...
		name: "Rigafagir",
		types: ["Ground", "Poison"],
		baseStats: { hp: 120, atk: 60, def: 110, spa: 60, spd: 110, spe: 60 },
		abilities: { 0: "Cud Chew", 1: "Armor Tail", H: "Poison Point" },
		heightm: 3.2,
		weightkg: 160,
		color: "Brown",
		prevo: "Girafarig Zornean",
		evoType: "levelMove",
		evoMove: "Twin Beam",
		eggGroups: ["Field"],
	},
	impidimpzornean: {
		num: -1705,
		name: "Impidimp Zornean",
		types: ["Ground", "Ghost"],
		gender: "M",
		baseStats: { hp: 40, atk: 60, def: 40, spa: 30, spd: 40, spe: 55 },
		abilities: { 0: "Lych Bane", 1: "Frisk", H: "Pickpocket" },
		heightm: 0.4,
		weightkg: 5.5,
		color: "Pink",
		evos: ["Morgrem Zornean"],
		eggGroups: ["Fairy", "Human-Like"],
	},
	morgremzornean: {
		num: -1706,
		name: "Morgrem Zornean",
		types: ["Ground", "Ghost"],
		gender: "M",
		baseStats: { hp: 65, atk: 80, def: 60, spa: 40, spd: 55, spe: 70 },
		abilities: { 0: "Lych Bane", 1: "Frisk", H: "Pickpocket" },
		heightm: 0.8,
		weightkg: 12.5,
		color: "Pink",
		prevo: "Impidimp Zornean",
		evoLevel: 32,
		nfe: true,
		evos: ["Grimmenace"],
		eggGroups: ["Fairy", "Human-Like"],
	...
	grimmenace: {
		...
		types: ["Ground", "Ghost"],
		gender: "M",
		baseStats: { hp: 90, atk: 130, def: 60, spa: 60, spd: 75, spe: 95 },
		abilities: { 0: "Lych Bane", 1: "Frisk", H: "Pickpocket" },
		heightm: 1.5,
		weightkg: 61,
		color: "Purple",
		prevo: "Morgrem Zornean",
		evoLevel: 42,
		eggGroups: ["Fairy", "Human-Like"],
	...
	hatennazornean: {
		num: -1708,
		name: "Hatenna Zornean",
		types: ["Ice", "Ghost"],
		gender: "F",
		baseStats: { hp: 50, atk: 30, def: 40, spa: 60, spd: 55, spe: 30 },
		abilities: { 0: "Fairy Tale", 1: "Anticipation", H: "Magic Bounce" },
		heightm: 0.4,
		weightkg: 3.4,
		color: "Pink",
		evos: ["Hattrem Zornean"],
		eggGroups: ["Fairy"],
	},
	hattremzornean: {
		num: -1709,
		name: "Hattrem Zornean",
		types: ["Ice", "Ghost"],
		gender: "F",
		baseStats: { hp: 70, atk: 55, def: 55, spa: 80, spd: 70, spe: 40 },
		abilities: { 0: "Fairy Tale", 1: "Anticipation", H: "Magic Bounce" },
		heightm: 0.6,
		weightkg: 4.8,
		color: "Pink",
		prevo: "Hatenna Zornean",
		nfe: true,
		evoLevel: 32,
		evos: ["Hatteerie"],
		eggGroups: ["Fairy"],
	...
	hatteerie: {
		...
		types: ["Ice", "Ghost"],
		gender: "F",
		baseStats: { hp: 100, atk: 50, def: 90, spa: 140, spd: 90, spe: 40 },
		abilities: { 0: "Fairy Tale", 1: "Anticipation", H: "Magic Bounce" },
		heightm: 2.1,
		weightkg: 5.1,
		color: "Pink",
		prevo: "Hattrem Zornean",
		evoLevel: 42,
		eggGroups: ["Fairy"],
	...
	mawilezornean: {
		...
		name: "Mawile Zornean",
		types: ["Psychic", "Grass"],
		baseStats: { hp: 50, atk: 55, def: 55, spa: 85, spd: 85, spe: 50 },
	...
	macarrion: {
		...
		name: "Macarrion",
		types: ["Psychic", "Grass"],
		baseStats: { hp: 77, atk: 63, def: 63, spa: 122, spd: 110, spe: 90 },
		abilities: { 0: "Psychic Surge", 1: "Intimidate", H: "Sheer Force" },
		heightm: 1.1,
		weightkg: 31.5,
		color: "Black",
		prevo: "Mawile Zornean",
		evoLevel: 28,
		eggGroups: ["Field", "Fairy"],
	},
	meowthzornean: {
		...
		name: "Meowth Zornean",
		types: ["Fire"],
		baseStats: { hp: 50, atk: 35, def: 35, spa: 65, spd: 45, spe: 60 },
		abilities: { 0: "Justified", 1: "Technician", H: "Unnerve" },
		heightm: 0.4,
		weightkg: 4.2,
		color: "Yellow",
		evos: ["Persian"],
	...
	persniper: {
		...
		name: "Persniper",
		types: ["Fire"],
		baseStats: { hp: 50, atk: 50, def: 50, spa: 140, spd: 50, spe: 100 },
		abilities: { 0: "Justified", 1: "Technician", H: "Unnerve" },
		heightm: 1,
		weightkg: 32,
		color: "Yellow",
		prevo: "Meowth Zornean",
		evoLevel: 28,
		eggGroups: ["Field"],
	},
	mimejrzornean: {
		num: -1715,
		name: "Mime Jr. Zornean",
		types: ["Fairy", "Dark"],
		baseStats: { hp: 40, atk: 30, def: 60, spa: 30, spd: 60, spe: 90 },
		abilities: { 0: "Soundproof", 1: "Filter", H: "Technician" },
		heightm: 0.6,
		weightkg: 13,
		color: "Pink",
		evos: ["Mr. Mime Zornean"],
		eggGroups: ["Undiscovered"],
		canHatch: true,
	},
	mrmimezornean: {
		num: -1716,
		name: "Mr. Mime Zornean",
		types: ["Fairy", "Dark"],
		baseStats: { hp: 60, atk: 50, def: 70, spa: 90, spd: 70, spe: 120 },
		abilities: { 0: "Vital Spirit", 1: "Filter", H: "Technician" },
		heightm: 1.4,
		weightkg: 56.8,
		color: "White",
		prevo: "Mime Jr. Zornean",
		evoType: "levelMove",
		evoMove: "Mimic",
		evoRegion: "Galar",
		evos: ["Mr. Prime"],
	...
	mrprime: {
		...
		name: "Mr. Prime",
		types: ["Fairy", "Dark"],
		baseStats: { hp: 75, atk: 60, def: 100, spa: 60, spd: 100, spe: 125 },
		abilities: { 0: "Screen Cleaner", 1: "Filter", H: "Ice Body" },
		heightm: 1.5,
		weightkg: 58.2,
		color: "Purple",
		prevo: "Mr. Mime Zornean",
		evoLevel: 42,
		eggGroups: ["Human-Like"],
	},
	rotomdrift: {
	...
	rotomrapid: {
		...
		gender: "N",
		baseStats: { hp: 107, atk: 85, def: 65, spa: 106, spd: 50, spe: 107 },
		abilities: { 0: "Levitate" },
		heightm: 0.3,
		weightkg: 0.3,
		color: "Red",
	...
	scarabeon: {
		...
		types: ["Bug"],
		genderRatio: { M: 0.875, F: 0.125 },
		baseStats: { hp: 60, atk: 130, def: 65, spa: 65, spd: 95, spe: 110 },
		abilities: { 0: "Swarm", H: "Moxie" },
		heightm: 1,
		weightkg: 25.5,
		color: "Green",
		prevo: "Eevee",
	...
	tauroszornean: {
		...
		abilities: { 0: "Heatproof", 1: "Vulcan Armor", H: "Sheer Force" },
		heightm: 1.4,
		weightkg: 88.4,
		color: "Brown",
		eggGroups: ["Field"],
	...
	venetar: {
		...
		name: "Venetar",
		types: ["Psychic", "Fairy"],
		baseStats: { hp: 50, atk: 50, def: 50, spa: 60, spd: 60, spe: 30 },
		abilities: { 0: "Compound Eyes", 1: "Tinted Lens", H: "Pastel Veil" },
		heightm: 1,
		weightkg: 30,
		color: "Purple",
		evos: ["Veneseer"],
	...
	veneseer: {
		...
		name: "Veneseer",
		types: ["Psychic", "Fairy"],
		baseStats: { hp: 70, atk: 65, def: 70, spa: 100, spd: 90, spe: 55 },
		abilities: { 0: "Wonder Skin", 1: "Tinted Lens", H: "Levitate" },
		heightm: 1.5,
		weightkg: 12.5,
		color: "Purple",
		prevo: "Venetar",
	...
	tragikarp: {
		...
		name: "Tragikarp",
		types: ["Rock"],
		baseStats: { hp: 75, atk: 15, def: 75, spa: 15, spd: 15, spe: 5 },
		abilities: { 0: "Sturdy", H: "Perish Body" },
		heightm: 0.9,
		weightkg: 10,
		color: "Red",
		evos: ["Zensodos"],
	...
	zensodos: {
		...
		name: "Zensodos",
		types: ["Rock", "Grass"],
		baseStats: { hp: 110, atk: 75, def: 130, spa: 75, spd: 90, spe: 60 },
		abilities: { 0: "Rain Dish", H: "Cursed Husk" },
		heightm: 6.5,
		weightkg: 235,
		color: "Blue",
		prevo: "Tragikarp",
	...
	cybone: {
		...
		name: "Cybone",
		types: ["Ice"],
		baseStats: { hp: 40, atk: 95, def: 40, spa: 40, spd: 40, spe: 65 },
		abilities: { 0: "Rock Head", 1: "Lightning Rod", H: "Snow Cloak" },
		heightm: 0.4,
		weightkg: 6.5,
		color: "Brown",
		evos: ["Zerowak"],
	...
	zerowak: {
		...
		name: "Zerowak",
		types: ["Ice"],
		baseStats: { hp: 55, atk: 110, def: 55, spa: 55, spd: 55, spe: 95 },
		abilities: { 0: "Rock Head", 1: "Lightning Rod", H: "Snow Cloak" },
		heightm: 1,
		weightkg: 45,
		color: "Brown",
	...
	salmaegis: {
		...
		name: "Salmaegis",
		types: ["Fire", "Fairy"],
		baseStats: { hp: 75, atk: 75, def: 90, spa: 75, spd: 90, spe: 120 },
		abilities: { 0: "Flash Fire", H: "Weak Armor" },
		heightm: 1.6,
		weightkg: 62,
		color: "Purple",
	...
	cofagrigusmegasealed: {
		num: -1730,
		name: "Cofagrigus-Mega (Sealed)",
		types: ["Ghost"],
		baseStats: { hp: 58, atk: 50, def: 170, spa: 125, spd: 150, spe: 30 },
		...
		otherFormes: ["Cofagrigus-Mega (Unsealed)"],
		formeOrder: ["Cofagrigus-Mega (Sealed)", "Cofagrigus-Mega (Unsealed)"],
	},
	cofagrigusmegaunsealed: {
		num: -1730,
		name: "Cofagrigus-Mega (Unsealed)",
		types: ["Ghost"],
		baseStats: { hp: 58, atk: 95, def: 65, spa: 165, spd: 55, spe: 145 },
		abilities: { 0: "Soul Touch" },
		heightm: 1.7,
		weightkg: 76.5,
		color: "Yellow",
		prevo: "Yamask",
	...
	culluroala: {
		...
		name: "Culluroala",
		types: ["Ground", "Fire"],
		baseStats: { hp: 95, atk: 130, def: 80, spa: 50, spd: 90, spe: 100 },
		abilities: { 0: "Gravity Generator", 1: "Water Compaction", H: "Steam Engine" },
		heightm: 2.8,
		weightkg: 160.5,
		color: "Black",
		prevo: "Carkol",
	...
	emolgamegaz: {
		...
		baseStats: { hp: 55, atk: 105, def: 70, spa: 105, spd: 70, spe: 123 },
		abilities: { 0: "Weather Absorber" },
		baseSpecies: "Emolga",
		forme: "Mega",
    heightm: 0.7,
    weightkg: 8,
  ...
  toxatrice: {
    ...
    name: "Toxatrice",
    types: ["Grass", "Poison"],
    baseStats: { hp: 65, atk: 107, def: 80, spa: 75, spd: 75, spe: 128 },
    abilities: { 0: "Overgrow", H: "Petrifying Gaze" },
    heightm: 1.6,
    weightkg: 75,
    color: "Green",
    eggGroups: ["Flying"],
  ...
  embarong: {
    ...
    name: "Embarong",
    types: ["Fire", "Fairy"],
    baseStats: { hp: 100, atk: 125, def: 90, spa: 65, spd: 70, spe: 80 },
    abilities: { 0: "Blaze", H: "Adrenaline Rush" },
    heightm: 1.5,
    weightkg: 115,
    color: "Red",
    eggGroups: ["Field"],
  ...
  abysshed: {
    ...
    name: "Abysshed",
    types: ["Water", "Ghost"],
    baseStats: { hp: 74, atk: 70, def: 60, spa: 102, spd: 105, spe: 119 },
    abilities: { 0: "Torrent", H: "Moon Blessing" },
    heightm: 2,
    weightkg: 82,
    color: "Blue",
    eggGroups: ["Water 1"],
  ...
  bunnelbyspringtrap: {
    ...
    types: ["Steel", "Normal"],
    baseStats: { hp: 37, atk: 37, def: 27, spa: 47, spd: 27, spe: 97 },
  ...
  diggersbyspringtrap: {
    ...
    types: ["Steel", "Ghost"],
    baseStats: { hp: 105, atk: 135, def: 87, spa: 40, spd: 87, spe: 87 },
    abilities: { 0: "Remnant"},
    heightm: 1.4,
    weightkg: 92.4,
    color: "Brown",
  ...
  cobbarisu: {
    ...
    name: "Cobbarisu",
    types: ["Electric", "Grass"],
    baseStats: { hp: 100, atk: 95, def: 85, spa: 95, spd: 75, spe: 65 },
    abilities: { 0: "Overgrow", 1: "The Lobber", H: "Volt Absorb" },
    heightm: 0.8,
    weightkg: 16,
    color: "Green",
    prevo: "Pachirisu",
  ...
  scorcherisu: {
    ...
    name: "Scorcherisu",
    types: ["Electric", "Fire"],
    baseStats: { hp: 70, atk: 115, def: 70, spa: 80, spd: 80, spe: 100 },
    abilities: { 0: "Blaze", 1: "Unyielding", H: "Volt Absorb" },
    heightm: 1,
    weightkg: 20,
    color: "Red",
    prevo: "Pachirisu",
  ...
  waverisu: {
    ...
    name: "Waverisu",
    types: ["Electric", "Water"],
    baseStats: { hp: 113, atk: 63, def: 75, spa: 90, spd: 81, spe: 93 },
    abilities: { 0: "Torrent", 1: "Shocking Currents", H: "Volt Absorb" },
    heightm: 1,
    weightkg: 22,
    color: "Blue",
    prevo: "Pachirisu",
  ...
  bulby: {
	...
	types: ["Grass", "Fairy"],
	genderRatio: { M: 0.875, F: 0.125 },
	baseStats: { hp: 87, atk: 71, def: 101, spa: 115, spd: 93, spe: 73 },
	abilities: { 0: "Purify" },
	heightm: 0.7,
	weightkg: 6.9,
	color: "Green",
  ...
  emolgamage: {
		...
		baseStats: { hp: 60, atk: 60, def: 60, spa: 105, spd: 75, spe: 108 },
		abilities: { 0: "Voltage Charge", H: "Motor Drive" },
		heightm: 0.4,
		weightkg: 5,
		color: "White",
		eggGroups: ["Field"],
  ...
  gourgeisthell: {
		...
		name: "Gourgeist-HELL",
		types: ["Water", "Grass"],
		baseStats: { hp: 93, atk: 54, def: 92, spa: 105, spd: 94, spe: 56 },
		abilities: { 0: "Anger Shell", 1: "Frisk", H: "Refreshing Juices" },
		heightm: 0.9,
		weightkg: 12.5,
		color: "Brown",
		eggGroups: ["Amorphous"],
	...
	trevenantmega: {
		...
		name: "Trevenant-Mega",
		types: ["Ghost", "Grass"],
		baseStats: { hp: 85, atk: 143, def: 98, spa: 82, spd: 110, spe: 56 },
		abilities: { 0: "Malicious Prank" },
		heightm: 2.7,
		weightkg: 151,
		color: "Brown",
	...
	flygonhell: {
		...
		name: "Flygon-HELL",
		types: ["Fire", "Bug"],
		baseStats: { hp: 80, atk: 80, def: 80, spa: 100, spd: 80, spe: 130 },
		abilities: { 0: "Levitate" },
		heightm: 2,
		weightkg: 82,
		color: "Red",
	...
	flygonmegahells: {
		...
		types: ["Fire", "Steel"],
		baseStats: { hp: 80, atk: 158, def: 95, spa: 106, spd: 95, spe: 116 },
		abilities: { 0: "Tera Slayer" },
		heightm: 3.5,
		weightkg: 229,
		color: "Red",
		requiredItem: "FlygoniteHELLS",
		baseSpecies: "Flygon-HELL",
		forme: "Mega",
		eggGroups: ["Bug", "Dragon"],
	},
	flygonmegahellh: {
		...
		types: ["Fire", "Steel"],
		baseStats: { hp: 80, atk: 158, def: 95, spa: 106, spd: 95, spe: 116 },
		abilities: { 0: "Mega Hunter" },
		heightm: 3.5,
		weightkg: 229,
		color: "Red",
		requiredItem: "FlygoniteHELLH",
		baseSpecies: "Flygon-HELL",
		forme: "Mega",
		eggGroups: ["Bug", "Dragon"],
	},
	...
	cinccinomega: {
		...
		types: ["Normal", "Fairy"],
		genderRatio: { M: 0.25, F: 0.75 },
		baseStats: { hp: 75, atk: 105, def: 110, spa: 65, spd: 110, spe: 105 },
  ...
  // End of Custom Pokemon
	...
	raichumegaxza: {
		...
		baseSpecies: "Raichu",
		forme: "Mega",
		requiredItem: "RaichiteXZA",
	},
	raichumegayza: {
		num: -26,
		name: "Raichu-Mega-Y-ZA",
		types: ["Electric"],
		...
		baseSpecies: "Raichu",
		forme: "Mega",
		requiredItem: "RaichiteYZA",
	},
	chimechomegaza: {
		num: -358,
		name: "Chimecho-Mega-ZA",
		types: ["Psychic", "Steel"],
		...
		forme: "Mega",
		requiredItem: "ChimechiteZA",
	},
	absolmegazza: {
		num: -359,
		name: "Absol-Mega-Z-ZA",
		types: ["Dark", "Ghost"],
		...
		baseSpecies: "Absol",
		forme: "Mega",
		requiredItem: "AbsoliteZZA",
	},
	staraptormegaza: {
		num: -398,
		name: "Staraptor-Mega-ZA",
		types: ["Fighting", "Flying"],
		...
		forme: "Mega",
		requiredItem: "StaraptoriteZA",
	},
	garchompmegazza: {
		num: -445,
		name: "Garchomp-Mega-Z-ZA",
		types: ["Dragon"],
		...
		forme: "Mega",
		requiredItem: "GarchompiteZZA",
	},
	lucariomegazza: {
		num: -448,
		name: "Lucario-Mega-Z-ZA",
		...
		baseSpecies: "Lucario",
		forme: "Mega",
		requiredItem: "LucarioniteZZA",
	},
	heatranmegaza: {
		num: -485,
		name: "Heatran-Mega-ZA",
		types: ["Fire", "Steel"],
		...
		baseSpecies: "Heatran",
		forme: "Mega",
		requiredItem: "HeatraniteZA",
	},
	darkraimegaza: {
		num: -491,
		name: "Darkrai-Mega-ZA",
		types: ["Dark"],
		gender: "N",
		baseStats: { hp: 70, atk: 120, def: 130, spa: 165, spd: 130, spe: 85 },
		abilities: { 0: "Petrifying Gaze" },
		heightm: 1.5,
		weightkg: 50.5,
		color: "Black",
		tags: ["Mythical"],
	...
	golurkmegaza: {
		...
		baseSpecies: "Golurk",
		forme: "Mega",
		requiredItem: "GolurkiteZA",
	},
	meowsticmegaza: {
		num: -678,
		name: "Meowstic-Mega-ZA",
		baseForme: "M",
		types: ["Psychic"],
		gender: "M",
		...
		forme: "Mega",
		requiredItem: "MeowsticiteZA",
	},
	crabominablemegaza: {
		num: -740,
		name: "Crabominable-Mega-ZA",
		types: ["Fighting", "Ice"],
		...
		forme: "Mega",
		requiredItem: "CrabominabiteZA",
	},
	golisopodmegaza: {
		num: -768,
		name: "Golisopod-Mega-ZA",
		types: ["Bug", "Steel"],
		...
		forme: "Mega",
		requiredItem: "GolisopoditeZA",
	},
	magearnamegaza: {
		num: -801,
		name: "Magearna-Mega-ZA",
		types: ["Steel", "Fairy"],
		gender: "N",
		...
		forme: "Mega",
		requiredItem: "MagearniteZA",
	},
	zeraoramegaza: {
		num: -807,
		name: "Zeraora-Mega-ZA",
		types: ["Electric"],
		gender: "N",
		baseStats: { hp: 88, atk: 157, def: 75, spa: 147, spd: 80, spe: 153 },
		abilities: { 0: "Super Conductor" },
		heightm: 1.5,
		weightkg: 44.5,
		color: "Yellow",
		tags: ["Mythical"],
		...
		baseSpecies: "Zeraora",
		forme: "Mega",
		requiredItem: "ZeraoriteZA",
	},
	scovillainmegaza: {
		num: -952,
		name: "Scovillain-Mega-ZA",
		types: ["Grass", "Fire"],
		...
		forme: "Mega",
		requiredItem: "ScovillainiteZA",
	},
	glimmoramegaza: {
		num: -970,
		name: "Glimmora-Mega-ZA",
		types: ["Rock", "Poison"],
		...
		forme: "Mega",
		requiredItem: "GlimmoriteZA",
	},
	tatsugirimegaza: {
		num: -978,
		name: "Tatsugiri-Mega-ZA",
		baseForme: "Curly",
		types: ["Dragon", "Water"],
		...
		forme: "Mega",
		requiredItem: "TatsugiriteZA",
	},
	baxcaliburmegaza: {
		num: -998,
		name: "Baxcalibur-Mega-ZA",
		types: ["Dragon", "Ice"],
	...
	charmeleon: {
		...
		prevo: "Charmander",
		evoLevel: 16,
		evos: ["Charizard", "Charizard-Prime"],
		eggGroups: ["Monster", "Dragon"],
	},
	charizard: {
		num: 6,
	...
	wartortle: {
		...
		prevo: "Squirtle",
		evoLevel: 16,
		evos: ["Blastoise", "Blastoise-Prime"],
		eggGroups: ["Monster", "Water 1"],
	},
	blastoise: {
		num: 9,
	...
	gloom: {
		...
		prevo: "Oddish",
		evoLevel: 21,
		evos: ["Vileplume", "Bellossom", "Vileplume-Prime"],
		eggGroups: ["Grass"],
	},
	vileplume: {
		num: 45,
	...
	eevee: {
		...
		weightkg: 6.5,
		color: "Brown",
		evos: ["Vaporeon", "Jolteon", "Flareon", "Espeon", "Umbreon", "Leafeon", "Glaceon", "Sylveon", "Nimbuseon", "Scarabeon", "Jolteon-Prime"],
		eggGroups: ["Field"],
	...
	quilava: {
		...
		prevo: "Cyndaquil",
		evoLevel: 14,
		evos: ["Typhlosion", "Typhlosion-Hisui", "Typhlosion-Prime"],
		eggGroups: ["Field"],
	},
	typhlosion: {
		num: 157,
	...
	croconaw: {
		...
		prevo: "Totodile",
		evoLevel: 18,
		evos: ["Feraligatr", "Feraligatr-Prime"],
		eggGroups: ["Monster", "Water 1"],
	},
	feraligatr: {
		num: 160,
	...
	bonsly: {
		...
		weightkg: 15,
		color: "Brown",
		evos: ["Sudowoodo", "Sudowoodo-Prime"],
		eggGroups: ["Undiscovered"],
		canHatch: true,
	},
	mimejr: {
	...
	rotom: {
		...
		color: "Red",
		eggGroups: ["Amorphous"],
		otherFormes: ["Rotom-Heat", "Rotom-Wash", "Rotom-Frost", "Rotom-Fan", "Rotom-Mow", "Rotom-Drift", "Rotom-Rapid"],
		formeOrder: ["Rotom", "Rotom-Heat", "Rotom-Wash", "Rotom-Frost", "Rotom-Fan", "Rotom-Mow", "Rotom-Drift", "Rotom-Rapid"],
	},
	rotomheat: {
		num: 479,
		name: "Rotom-Heat",
	...
	basculinwhitestriped: {
		...
		weightkg: 18,
		color: "Green",
		evos: ["Basculegion", "Basculegion-F", "Basculegion-Prime"],
		eggGroups: ["Water 2"],
		gen: 8,
	},
	sandile: {
	...
	vullaby: {
		...
		weightkg: 9,
		color: "Brown",
		evos: ["Mandibuzz", "Mandibuzz-Prime"],
		eggGroups: ["Flying"],
	},
	mandibuzz: {
		num: 630,
	...
	tyrunt: {
		...
		weightkg: 26,
		color: "Brown",
		evos: ["Tyrantrum", "Tyrantrum-Prime"],
		eggGroups: ["Monster", "Dragon"],
	},
	tyrantrum: {
		num: 697,
	...
	corvisquire: {
		...
		prevo: "Rookidee",
		evoLevel: 18,
		evos: ["Corviknight", "Corviknight-Prime"],
		eggGroups: ["Flying"],
	},
	corviknight: {
		num: 823,
	...
	arrokuda: {
		...
		weightkg: 1,
		color: "Brown",
		evos: ["Barraskewda", "Barraskewda-Prime"],
		eggGroups: ["Water 2"],
	},
	barraskewda: {
		num: 847,
	...
	charcadet: {
		...
		weightkg: 10.5,
		color: "Red",
		evos: ["Armarouge", "Ceruledge", "Herobsidian", "Archivory", "Turquolance", "Salmaegis"],
		eggGroups: ["Human-Like"],
	},
	armarouge: {
		num: 936,
	...
	bramblin: {
		...
		weightkg: 0.6,
		color: "Brown",
		evos: ["Brambleghast", "Brambleghast-Prime"],
		eggGroups: ["Grass"],
	},
	brambleghast: {
		num: 947,
	...
	varoom: {
		...
		weightkg: 35,
		color: "Gray",
		evos: ["Revavroom", "Revavroom-Prime"],
		eggGroups: ["Mineral"],
	},
	revavroom: {
		num: 966,
